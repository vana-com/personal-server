...
import type { AccessLogWriter, AccessLogEntry } from '@personal-server/core/logging/access-log'
import type { VerifiedAuth } from '@personal-server/core/auth'
import type { GatewayGrantResponse } from '@personal-server/core/grants'

function createMockWriter(overrides: Partial<AccessLogWriter> = {}): AccessLogWriter & { write: ReturnType<typeof vi.fn> } {
  return {
...
function createApp(writer: AccessLogWriter, options: { status?: number; setAuth?: boolean; setGrant?: boolean } = {}) {
